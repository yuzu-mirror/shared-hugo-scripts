...
const githubRepoCompatDbName = process.env.GITHUB_REPO_NAME;
const githubRepoOwner = process.env.GITHUB_REPO_OWNER;

const fsPathCode = `./${githubRepoCompatDbName}/games`;
const fsPathWiki = `./${githubRepoCompatDbName}.wiki`;
const fsPathHugoSite = './../../../site';
const fsPathHugoContent = `${fsPathHugoSite}/content/game`;
const fsPathHugoStaticImagesGame = `${fsPathHugoSite}/static/images/game`;
const fsPathHugoBoxart = `${fsPathHugoSite}/static/images/game/boxart`;
...
setup().then(function() {
  ...
  [fsPathHugoContent, fsPathHugoStaticImagesGame, fsPathHugoBoxart, fsPathHugoIcon, fsPathHugoSavefiles, fsPathHugoScreenshots].forEach(function (path) {
